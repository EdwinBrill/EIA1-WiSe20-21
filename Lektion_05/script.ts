...
console.log('Relativ zur Gesamtemission der Welt verursacht Süd Amerika damit ' + (100 / (Gesamt / SouthAmerica18)).toFixed(1) + '%');
...
console.log('Relativ zur Gesamtemission der Welt verursacht Nord Amerika damit ' + (100 / (Gesamt / NorthAmerica18)).toFixed(1) + '%');
