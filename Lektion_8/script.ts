...
function playSample (soundName:string) {
    var audioObject:HTMLAudioElement = new Audio(soundName);
    audioObject.play();
    if (recording == true) {
...
var sequence:number [] = [2, 1, 1, 0, 3, 3, 3, 3, 0, 2, 1, 1, 0, 3, 3, 3, 3, 0, 4, 6];
...
document.getElementById('stop_button').addEventListener('click', function (): void {
    this.classList.add("is-hidden");
